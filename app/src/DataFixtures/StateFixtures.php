...
class StateFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        for ($i = 0; $i < 10; $i++) {
            ...
            $book = $this->getReference(BookFixtures::BOOK_FIXTURE_REFERENCE . '_' . $this->faker->numberBetween(0, 49));
            $reader = $this->getReference(ReaderFixtures::READER_FIXTURE_REFERENCE . '_' . $this->faker->numberBetween(0, 19));
